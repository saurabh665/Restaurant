    ...
    <div className="p-6 mx-auto px-4 max-w-7xl">
      ...
      <div className="mb-6 relative">
        <img 
          ...
          alt="Map" 
        />
        <div className="absolute top-0 left-0  h-full ml-40  flex flex-col justify-center p-4```jsx
import React from 'react';
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="mb-6 relative">
        ...
        <div className="absolute top-0 left-0  h-full ml-40  flex flex-col justify-center p-4">
          ...
          <p className="mt-2 text-white">Tooley St, London Bridge, <br/>London SE1 2TF, United Kingdom</p>
